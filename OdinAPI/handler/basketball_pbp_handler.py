...
from .dao.pbp_dao import PBPDao as BasketballPBPDao
from handler.event import EventHandler
from handler.team import TeamHandler


class BasketballPBPHandler:
    '''
    BasketballPBPHandler - This class handles incomming requests from Odin API's gateway
    ...
    def __init__(self):
        """
        Default constructor - initialize keywords that apply to Basketball PBP sequences.
        """
    ...
    def _handle_pbp_action(self, event_id, action, dao):
        """
        Internal method for handling Basketball PBP Actions via a PBPDao.
        """
        ...
        if action_type == self._sport_keywords["adjust"]:
            ...
            # Adding Basketball rules for scoring:
        ...
        if action_type in self._sport_keywords["3Points_actions"]:
    ...
    def removeUPRMPlayer(self, event_id,  player_id):
        ...
        try:
            ...
            meta = pbp_dao.get_pbp_meta(event_id)
            if self._sport_keywords["sport"] != meta["sport"]:
                return jsonify(Error="Esta secuencia PBP no corresponde a Balonncesto."), 403
    ...
    def addPBPAction(self, event_id, action_data):
        ...
        This function interacts with the PBP DAO to insert a Basketball game action.
    ...
    def editPBPAction(self, event_id, action_id, new_action):
        ...
        This function interacts with the PBP DAO to edit a Basketball game action
    ...
    def removePlayPBPAction(self, event_id, game_action_id):
        ...
        This function interacts with the PBP DAO to remove a Basketball game action.
    ...
    def setPBPSequenceOver(self, event_id):
        ...
        This function interacts with the PBP DAO to modify the game-ended status of a Basketball
