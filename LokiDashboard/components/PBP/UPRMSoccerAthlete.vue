      ...
      <v-col :cols="3">
        <v-row justify="center">
          <v-avatar size="110" class="mx-10">
            <v-icon x-large color="primary" v-if="!athlete_img" height="110px"
              >mdi-account</v-icon
            >
      ...
      <v-col justify="left">
        <v-row>
          <v-card-text
            ...
            >Nombre: {{ athlete_first_name }}
            {{ athlete_last_names }}</v-card-text
          >
          <v-card-text
            v-else
            class="headline text-left"
            style="headline word-break: normal;"
            >Nombre: {{ athlete_first_name }} {{ athlete_middle_name }}
            {{ athlete_last_names }}</v-card-text
          >
        </v-row>
        <v-row>
