    ...
    <v-dialog v-model="time_dialog" persistent max-width="500">
      <v-card>
        ...
        <v-container max-width="200">
          <v-text-field v-model="foo1" min=0 max=9 type="number" label="Minutos" placeholder="90"  :rules="time_rules"></v-text-field>
...
export default {
  ...
  methods: {
    ...
    if ((this.minutos >= 0 && this.minutos <= 90)&&(this.segundos >= 0 && this.segundos < 60)) {
      if(this.segundos<10){
