...
import UPRMAthleteBaseball from "../components/PBP/UPRMAthleteBaseball";
import OppAthleteBaseball from "../components/PBP/OppAthleteBaseball";
...
export default {
  ...
  data: () => ({
    ...
    // Action button flags.
    action_buttons: [
      { key: 1, action_type: "Hit", button_state: false },
      { key: 2, action_type: "Run", button_state: false },
      { key: 3, action_type: "AtBat", button_state: false },
      { key: 4, action_type: "RunBattedIn", button_state: false },
      { key: 7, action_type: "Homerun", button_state: false },
      { key: 8, action_type: "StrikeOut", button_state: false },
      { key: 9, action_type: "Out", button_state: false },
      { key: 10, action_type: "BaseOnBall", button_state: false },
      { key: 11, action_type: "LeftOnBase", button_state: false }
    ],
  ...
  methods: {
    ...mapActions({
      ...
      addPBPAthlete: "BaseballPBP/addPBPAthlete",
      notifyNotActionSelected: "BaseballPBP/notifyNotActionSelected"
    }),
    ...
    map_action(action_name) {
      switch (action_name) {
        ...
        case "RunBattedIn":
          return "Carrera Empujada";

        case "StrikeOut":
          return "Ponche";

        case "BaseOnBall":
          return "Base Por Bola";

        case "LeftOnBase":
          return "Dejado En Base";
