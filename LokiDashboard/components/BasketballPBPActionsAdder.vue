...
import UPRMAthleteBasketball from "../components/PBP/UPRMAthleteBasketball";
import OppAthleteBasketball from "../components/PBP/OppAthleteBasketball";
...
export default {
  ...
  methods: {
    ...mapActions({
      ...
      addPBPAthlete: "BasketballPBP/addPBPAthlete",
      notifyNotActionSelected: "BasketballPBP/notifyNotActionSelected"
    }),
