...
export default {
    ...
    async sendSetAdjust({ commit, dispatch }, payload) {
        try {
            ...
            const response = await this.$axios.put(`/pbp/Baloncesto/set`, payload);
    ...
    async sendGameAction({ commit, dispatch }, payload) {
        try {
            ...
            const response = await this.$axios.post(`/pbp/Baloncesto/actions`, payload);
            dispatch('notifications/setSnackbar', { text: response.data.MSG, color: 'success' }, { root: true })
            return true;
        } catch (error) {
    ...
    async updateGameAction({ commit, dispatch }, payload) {
        try {
            ...
            const response = await this.$axios.put(`/pbp/Baloncesto/actions`, payload);
            dispatch('notifications/setSnackbar', { text: response.data.MSG, color: 'success' }, { root: true })
            return true;
        } catch (error) {
            if (!!error.response) {
    ...
    async removeGameAction({ commit, dispatch }, payload) {
        try {
            const response = await this.$axios.delete(`/pbp/Baloncesto/actions?event_id=${payload.event_id}&action_id=${payload.action_id}`);
            dispatch('notifications/setSnackbar', { text: response.data.MSG, color: 'success' }, { root: true })
            return true;
        } catch (error) {
            if (!!error.response) {
    ...
    async updateOpponentColor({ commit, dispatch }, payload) {
        try {
            const response = await this.$axios.put(`/pbp/Baloncesto/color`, payload);
            dispatch('notifications/setSnackbar', { text: response.data.MSG, color: 'success' }, { root: true })
            return true;
        } catch (error) {
            if (!!error.response) {
    ...
    async addPBPAthlete({ commit, dispatch }, payload) {
        try {
            const response = await this.$axios.post(`/pbp/Baloncesto/roster`, payload);
            dispatch('notifications/setSnackbar', { text: response.data.MSG, color: 'success' }, { root: true })
            return true;
        } catch (error) {
            if (!!error.response) {
    ...
    async updateOppAthlete({ commit, dispatch }, payload) {
        try {
            const response = await this.$axios.put(`/pbp/Baloncesto/roster`, payload);
            dispatch('notifications/setSnackbar', { text: response.data.MSG, color: 'success' }, { root: true })
            return true;
        } catch (error) {
            if (!!error.response) {
    ...
    async removeAthlete({ commit, dispatch }, args) {
        try {
            const response = await this.$axios.delete(`/pbp/Baloncesto/roster?${args}`);
            dispatch('notifications/setSnackbar', { text: response.data.MSG, color: 'success' }, { root: true })
            return true;
        } catch (error) {
            if (!!error.response) {
