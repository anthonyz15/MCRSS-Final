...
export default {
    ...
    async sendSetAdjust({ commit, dispatch }, payload) {
        try {
            ...
            const response = await this.$axios.put(`/pbp/Beisbol/set`, payload);
    ...
    async sendGameAction({ commit, dispatch }, payload) {
        try {
            ...
            const response = await this.$axios.post(`/pbp/Beisbol/actions`, payload);
            dispatch('notifications/setSnackbar', { text: response.data.MSG, color: 'success' }, { root: true })
            return true;
        } catch (error) {
    ...
    async updateGameAction({ commit, dispatch }, payload) {
        try {
            ...
            const response = await this.$axios.put(`/pbp/Beisbol/actions`, payload);
            dispatch('notifications/setSnackbar', { text: response.data.MSG, color: 'success' }, { root: true })
            return true;
        } catch (error) {
            if (!!error.response) {
    ...
    async removeGameAction({ commit, dispatch }, payload) {
        try {
            const response = await this.$axios.delete(`/pbp/Beisbol/actions?event_id=${payload.event_id}&action_id=${payload.action_id}`);
            dispatch('notifications/setSnackbar', { text: response.data.MSG, color: 'success' }, { root: true })
            return true;
        } catch (error) {
            if (!!error.response) {
    ...
    async endPBPSequence({ commit, dispatch }, payload) {
        try {
            const response = await this.$axios.post(`/pbp/Beisbol/end`, payload);
            dispatch('notifications/setSnackbar', { text: response.data.MSG, color: 'success' }, { root: true })
        } catch (error) {
            if (!!error.response) {
                dispatch('notifications/setSnackbar', { text: error.response.data.Error, color: 'error' }, { root: true })
    ...
    async updateOpponentColor({ commit, dispatch }, payload) {
        try {
            const response = await this.$axios.put(`/pbp/Beisbol/color`, payload);
            dispatch('notifications/setSnackbar', { text: response.data.MSG, color: 'success' }, { root: true })
            return true;
        } catch (error) {
            if (!!error.response) {
    ...
    async addPBPAthlete({ commit, dispatch }, payload) {
        try {
            const response = await this.$axios.post(`/pbp/Beisbol/roster`, payload);
            dispatch('notifications/setSnackbar', { text: response.data.MSG, color: 'success' }, { root: true })
            return true;
        } catch (error) {
            if (!!error.response) {
    ...
    async updateOppAthlete({ commit, dispatch }, payload) {
        try {
            const response = await this.$axios.put(`/pbp/Beisbol/roster`, payload);
            dispatch('notifications/setSnackbar', { text: response.data.MSG, color: 'success' }, { root: true })
            return true;
        } catch (error) {
            if (!!error.response) {
    ...
    async removeAthlete({ commit, dispatch }, args) {
        try {
            const response = await this.$axios.delete(`/pbp/Beisbol/roster?${args}`);
            dispatch('notifications/setSnackbar', { text: response.data.MSG, color: 'success' }, { root: true })
            return true;
        } catch (error) {
            if (!!error.response) {
